<?if(count($arResult["status_array"])):?>
	...
	<?foreach($arResult["status_array"] as $infoArray):?>
		...
		<li>
			...
			<?if($infoArray["type"] == 'boss_confirm' && $arResult["stage_description"] && $infoArray["boss_id"]):?>
			<div text>
			...
			<?if($infoArray["type"] == 'manager_confirm' && $arResult["stage_description"] && $infoArray["manager_id"]):?>
			<div text>
